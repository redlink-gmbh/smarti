...
public class AnalysisContext extends io.redlink.nlp.api.ProcessingData {
    
    protected AnalysisContext(Conversation conversation, Analysis analysis, AnalyzedText at) {
    ...
    public static AnalysisContext create(Conversation conversation){
        return create(conversation, null);
    }
    
    public static AnalysisContext create(Conversation conversation, Analysis analysis){
        ...
        return new AnalysisContext(conversation, analysis, atb.create());
    }
    /**
     * Shorthand for {@link #getAnnotation(Annotation)} with {@link SmartiAnnotations#CONVERSATION_ANNOTATION}
     * @return the Conversation for this {@link AnalysisContext}
     */
     ...
     * @return the Analysis for this {@link AnalysisContext}
     */
