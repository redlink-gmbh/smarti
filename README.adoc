...
be started by directly launching the executable jar. Check out a detailed link:docs/installation/installation.adoc[installation description] including system requirements.
...
== License
Free use of this software is granted under the terms of the Apache License Version 2.0 License.
See the link:LICENSE.txt[License] for more details.

== Authors
Smarti is lead by http://redink.co[Redlink] and http://assistify.de[Assistify] and was initiated in 2017.
