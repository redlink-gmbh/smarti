...
For more information on the configuration of Interesting Term Extractors see the according <<index.asciidoc#_interesting_term,section>> in the Smarti Configuration
...
See the <<index.asciidoc#_token_filter_stopword, Stoword Token Filter configuration>> section of the Smarti Configuration for more information.
