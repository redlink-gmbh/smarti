...
If you like to setup your development client or a non-productive server read section <<developer-guide.adoc#,Build and Run>> explains how to do start Smarti by executing the executable jar.
