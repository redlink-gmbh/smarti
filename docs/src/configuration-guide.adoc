...
Configuration is done via a <<../webservices/client-api.adoc, RESTful web service>> or via the provided configuration UI.

include::configurations/administration-ui.adoc[]
