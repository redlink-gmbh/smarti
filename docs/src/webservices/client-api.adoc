...
NOTE: The defaults can be set in via `application.properties`. See <<index.adoc#_query_builder_defalt_configuration, query builder default configuration>> for details.
