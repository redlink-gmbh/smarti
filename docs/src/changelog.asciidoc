...
* https://github.com/redlink-gmbh/smarti/issues/293[#294 - Disable analysis for Conversation Updates that do not explicitly request Analysis Data in the Response] 
