...
For more information on the configuration of Interesting Term Extractors see the according <<index.adoc#_interesting_term,section>> in the Smarti Configuration
